    ...
    <div className="w-full mb-12 animate-fade-in">
      ...
      <div className="bg-gray-100 rounded-lg overflow-hidden shadow-lg mb-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
          ...
          <div className="p-8 lg:p-12 flex flex-col justify-center">
            <h2 className="text-4xl lg:text-5xl font-black text-gray-900 uppercase tracking-tight mb-2">
              NEWSLETTER
            </h2>
            <h3 className="text-4xl lg:text-5xl font-black text-gray-600 uppercase tracking-tight mb-8">
              SUBSCRIPTION
            </h3>
          ...
          <div className="relative h-64 lg:h-auto overflow-hidden">
            <img
              src="https://images.unsplash.com/photo-1579952363873-27f3bade9f55?w=800&h=600&fit=crop&q=80&auto=format"
            ...
            <div className="absolute bottom-0 left-0 w-24 h-24 bg-gray-300/20 rounded-full blur-2xl"></div>
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-6 pt-8 border-t border-gray-200">
        ...
        <div className="flex items-center gap-2">
          ...
          >
            <svg
              className={`w-5 h-5 ${currentPage === 1 ? 'text-gray-400' : 'text-white'}`}
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
          ...
          >
            <svg
              className={`w-5 h-5 ${currentPage === totalPages ? 'text-gray-400' : 'text-white'}`}
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
